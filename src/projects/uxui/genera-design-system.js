const Genera = { //todo projeto é necessário mudar o nome do const
  
  title: "Genera Design System", //o título tem que ser exatamente igual ao nome do arquivo, se não dá ruim
  year: "2022",
  link: "genera.com.br", //opcional
  color: "bg-white dark:bg-slate-900", //cores do projeto, só escolher no tailwind
  image: `${process.env.PUBLIC_URL}/img/genera/genera.jpg`, //imagem de fundo do hero
  thumb: `${process.env.PUBLIC_URL}/img/genera/genera-thumb.png`, //thumbnail
  description:

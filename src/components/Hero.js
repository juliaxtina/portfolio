   ...
   <>
    ...
    <div class="grid gap-16 max-w-screen-xl px-4 py-16 mx-auto lg:grid lg:grid-cols-2 lg:py-24 lg:px-6">
        <div class="mr-auto place-self-center">
            <h1 class="max-w-2xl my-6 text-7xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-7xl dark:text-gray-100">Elevating User Journeys Through Design</h1>
          
            <p class="max-w-2xl mb-6 mt-8 font-body text-gray-500 lg:mb-8 md:text-lg lg:text-2xl dark:text-gray-400">I am a dedicated designer committed to resolving challenges, crafting intuitive interfaces, and ensuring your competitive edge remains unmatched. </p>
